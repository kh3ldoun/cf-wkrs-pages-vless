...
// 建议修改为自己的 UUID
let userID = 'c8eb4fe0-73bc-453a-850c-f1c12067bfc9';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "edgetunnel.anycast.eu.org"

// 用于 CF 网站的代理 IP
const proxyIPs = ["workers.cloudflare.cyou",'ProxyIP.DE.tp2024.fxxk.dedyn.io']; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
